 ...
 */
@Schema(description = "Nhóm tài sản: CNTT, Văn phòng, ...")
...
public class AssetGroupDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssetGroupDTO)) {
            return false;
        }

        AssetGroupDTO assetGroupDTO = (AssetGroupDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, assetGroupDTO.id);
    }
