...
import static com.gindevp.app.domain.LocationAsserts.*;
...
class LocationResourceIT {
    ...
    public static Location createEntity() {
        return new Location().code(DEFAULT_CODE).name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).active(DEFAULT_ACTIVE);
    }
    ...
    public static Location createUpdatedEntity() {
        return new Location().code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
