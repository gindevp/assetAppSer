...
import static com.gindevp.app.domain.DepartmentAsserts.*;
...
import com.gindevp.app.repository.DepartmentRepository;
import com.gindevp.app.service.dto.DepartmentDTO;
import com.gindevp.app.service.mapper.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity() {
        return new Department().code(DEFAULT_CODE).name(DEFAULT_NAME).active(DEFAULT_ACTIVE);
    }
    ...
    public static Department createUpdatedEntity() {
        return new Department().code(UPDATED_CODE).name(UPDATED_NAME).active(UPDATED_ACTIVE);
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.code(UPDATED_CODE).name(UPDATED_NAME).active(UPDATED_ACTIVE);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.code(UPDATED_CODE).name(UPDATED_NAME).active(UPDATED_ACTIVE);
